...
- [community-scripts/ProxmoxVE](https://github.com/community-scripts/ProxmoxVE) ([2026-03-19](https://github.com/community-scripts/ProxmoxVE/releases/tag/2026-03-19), today) - Proxmox VE Helper-Scripts (Community Edition) 
...
- [build](https://github.com/lucacome/karabiner/pull/12) on [lucacome/karabiner](https://github.com/lucacome/karabiner) (3 days ago)
...
- [Remove old CircleCI jobs](https://github.com/opentracing-contrib/nginx-opentracing/pull/1059) on [opentracing-contrib/nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) (1 week ago)
- [Build modules for NGINX 1.29.6](https://github.com/opentracing-contrib/nginx-opentracing/pull/1058) on [opentracing-contrib/nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) (1 week ago)
...
- [mostpinkest/pam-watchid](https://github.com/mostpinkest/pam-watchid) - PAM plugin module that allows the Apple Watch to be used for authentication (2 days ago)
