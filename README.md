...
- [opentracing-contrib/nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) ([v0.47.0](https://github.com/opentracing-contrib/nginx-opentracing/releases/tag/v0.47.0), 1 day ago) - NGINX plugin for OpenTracing
...
- [Remove date from trixie](https://github.com/opentracing-contrib/nginx-opentracing/pull/1123) on [opentracing-contrib/nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) (2 days ago)
- [Build modules for NGINX 1.30.2 and 1.31.1](https://github.com/opentracing-contrib/nginx-opentracing/pull/1120) on [opentracing-contrib/nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) (6 days ago)
...
- [FelixKratz/SketchyBar](https://github.com/FelixKratz/SketchyBar) - A highly customizable macOS status bar replacement (2 weeks ago)
