...
- [tynany/frr_exporter](https://github.com/tynany/frr_exporter) ([v1.7.0](https://github.com/tynany/frr_exporter/releases/tag/v1.7.0), 1 day ago) - Prometheus exporter for Free Range Routing
- [nginx/agent](https://github.com/nginx/agent) ([v2.41.1](https://github.com/nginx/agent/releases/tag/v2.41.1), 2 days ago) - NGINX Agent provides an administrative entry point to remotely manage, configure and collect metrics and events from NGINX instances
