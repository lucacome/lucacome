...
- [prometheus/common](https://github.com/prometheus/common) ([v0.49.0](https://github.com/prometheus/common/releases/tag/v0.49.0), 6 days ago) - Go libraries shared across Prometheus components and libraries.
...
- [Create codeql.yml](https://github.com/nginxinc/telemetry-exporter/pull/29) on [nginxinc/telemetry-exporter](https://github.com/nginxinc/telemetry-exporter) (6 days ago)
- [Speed up generation](https://github.com/nginxinc/nginx-gateway-fabric/pull/1628) on [nginxinc/nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) (6 days ago)
- [Bump Node to v20 and add .nvmrc](https://github.com/nginxinc/nginx-gateway-fabric/pull/1627) on [nginxinc/nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) (6 days ago)
