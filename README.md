...
- [opentracing-contrib/go-stdlib](https://github.com/opentracing-contrib/go-stdlib) ([v1.1.1](https://github.com/opentracing-contrib/go-stdlib/releases/tag/v1.1.1), 2 days ago) - OpenTracing instrumentation for packages in the Go stdlib
- [nginx/nginx-asg-sync](https://github.com/nginx/nginx-asg-sync) ([v1.0.2](https://github.com/nginx/nginx-asg-sync/releases/tag/v1.0.2), 3 days ago) - NGINX Plus Integration with Cloud Autoscaling 
- [nginx/alpine-fips](https://github.com/nginx/alpine-fips) ([v0.5.0](https://github.com/nginx/alpine-fips/releases/tag/v0.5.0), 3 weeks ago) - Alpine Linux with FIPS OpenSSL module
...
- [Fix lint errors](https://github.com/opentracing-contrib/go-stdlib/pull/92) on [opentracing-contrib/go-stdlib](https://github.com/opentracing-contrib/go-stdlib) (2 days ago)
