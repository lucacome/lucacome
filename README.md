...
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([v2.4.8](https://github.com/goreleaser/goreleaser/releases/tag/v2.4.8), 6 days ago) - Deliver Go binaries as fast and easily as possible
- [kubeshop/testkube](https://github.com/kubeshop/testkube) ([v2.1.70](https://github.com/kubeshop/testkube/releases/tag/v2.1.70), 6 days ago) - ☸️ Kubernetes-native testing framework for test execution and orchestration
...
- [Update github.com/opentracing/opentracing-go to v1.2.0](https://github.com/opentracing-contrib/go-stdlib/pull/69) on [opentracing-contrib/go-stdlib](https://github.com/opentracing-contrib/go-stdlib) (3 weeks ago)
