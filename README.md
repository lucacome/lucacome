...
- [kubernetes-sigs/controller-runtime](https://github.com/kubernetes-sigs/controller-runtime) ([v0.17.3](https://github.com/kubernetes-sigs/controller-runtime/releases/tag/v0.17.3), 1 day ago) - Repo for the controller-runtime subproject of kubebuilder (sig-apimachinery)
...
- [prometheus/common](https://github.com/prometheus/common) ([v0.52.2](https://github.com/prometheus/common/releases/tag/v0.52.2), 6 days ago) - Go libraries shared across Prometheus components and libraries.
