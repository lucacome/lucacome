...
- [opentracing-contrib/common](https://github.com/opentracing-contrib/common) -  (4 weeks ago)
- [opentracing-contrib/python-requests](https://github.com/opentracing-contrib/python-requests) - OpenTracing instrumentation for Requests (4 weeks ago)
...
- [kubeshop/testkube](https://github.com/kubeshop/testkube) ([v2.1.140](https://github.com/kubeshop/testkube/releases/tag/v2.1.140), 1 day ago) - ☸️ Kubernetes-native testing framework for test execution and orchestration
- [atuinsh/atuin](https://github.com/atuinsh/atuin) ([v18.5.0](https://github.com/atuinsh/atuin/releases/tag/v18.5.0), 3 days ago) - ✨ Magical shell history
- [onsi/ginkgo](https://github.com/onsi/ginkgo) ([v2.23.4](https://github.com/onsi/ginkgo/releases/tag/v2.23.4), 6 days ago) - A Modern Testing Framework for Go
...
- [Add domain field to fastmail-masked-email extension](https://github.com/raycast/extensions/pull/18468) on [raycast/extensions](https://github.com/raycast/extensions) (3 days ago)
