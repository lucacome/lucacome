...
- [nginx/agent](https://github.com/nginx/agent) ([v3.0.1](https://github.com/nginx/agent/releases/tag/v3.0.1), 1 day ago) - NGINX Agent provides an administrative entry point to remotely manage, configure and collect metrics and events from NGINX instances
- [nginx/nginx-gateway-fabric](https://github.com/nginx/nginx-gateway-fabric) ([v2.0.0](https://github.com/nginx/nginx-gateway-fabric/releases/tag/v2.0.0), 6 days ago) - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane.
- [lucacome/draft-release](https://github.com/lucacome/draft-release) ([v1.2.3](https://github.com/lucacome/draft-release/releases/tag/v1.2.3), 6 days ago) - Draft the next GitHub release
