...
- [Add AGENTS.md](https://github.com/lucacome/draft-release/pull/857) on [lucacome/draft-release](https://github.com/lucacome/draft-release) (4 days ago)
...
- [mostpinkest/pam-watchid](https://github.com/mostpinkest/pam-watchid) - PAM plugin module that allows the Apple Watch to be used for authentication (6 days ago)
